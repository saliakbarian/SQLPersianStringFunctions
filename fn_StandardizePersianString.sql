...
BEGIN
	...
	BEGIN
		...
		SET @UC=UNICODE(@C)
		IF @UC IN (0x200D) --> Nonvisible space => will be removed from the string
			CONTINUE
		ELSE IF @UC IN (0x0009,0x000A,0x000B,0x000C,0x000D,0x0020,0x0085,0x00A0,0x1680,0x2000,0x2001
